...
<p class='note'>
In order to follow these steps you should have ssh accesst to your Home Assistant instance. When you have installed [Hass.io](/hassio/)  via the [Getting Started](/getting-started/) guide you need to activate the [SSH server add-on](/addons/ssh/) to get ssh access.
</p>
